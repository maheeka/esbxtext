...
public class EsbDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cIntegrationFlowKeyword_0_1 = (Keyword)cGroup_0.eContents().get(1);
		private final Keyword cColonKeyword_0_2 = (Keyword)cGroup_0.eContents().get(2);
		private final Assignment cIntegrationFlowNameAssignment_0_3 = (Assignment)cGroup_0.eContents().get(3);
		private final RuleCall cIntegrationFlowNameIDTerminalRuleCall_0_3_0 = (RuleCall)cIntegrationFlowNameAssignment_0_3.eContents().get(0);
		private final Assignment cParticipantsAssignment_0_4 = (Assignment)cGroup_0.eContents().get(4);
		private final RuleCall cParticipantsParticipantStatementParserRuleCall_0_4_0 = (RuleCall)cParticipantsAssignment_0_4.eContents().get(0);
		...
		//'@startuml' 'IntegrationFlow' ':' integrationFlowName=ID participants+=ParticipantStatement* & statements+=Statement*
		//'@enduml'
		public UnorderedGroup getUnorderedGroup() { return cUnorderedGroup; }
		
		//'@startuml' 'IntegrationFlow' ':' integrationFlowName=ID participants+=ParticipantStatement*
		...
		//'IntegrationFlow'
		public Keyword getIntegrationFlowKeyword_0_1() { return cIntegrationFlowKeyword_0_1; }
		
		//':'
		public Keyword getColonKeyword_0_2() { return cColonKeyword_0_2; }
		
		//integrationFlowName=ID
		public Assignment getIntegrationFlowNameAssignment_0_3() { return cIntegrationFlowNameAssignment_0_3; }
		
		//ID
		public RuleCall getIntegrationFlowNameIDTerminalRuleCall_0_3_0() { return cIntegrationFlowNameIDTerminalRuleCall_0_3_0; }
		
		//participants+=ParticipantStatement*
		public Assignment getParticipantsAssignment_0_4() { return cParticipantsAssignment_0_4; }
		
		//ParticipantStatement
		public RuleCall getParticipantsParticipantStatementParserRuleCall_0_4_0() { return cParticipantsParticipantStatementParserRuleCall_0_4_0; }
	...
	public class MediatorStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.wso2.esb.dsl.EsbDsl.MediatorStatement");
	...
	public class OutboundEndpointDefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.wso2.esb.dsl.EsbDsl.OutboundEndpointDef");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class InboundEndpointDefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.wso2.esb.dsl.EsbDsl.InboundEndpointDef");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MediatorTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "com.wso2.esb.dsl.EsbDsl.MediatorType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
